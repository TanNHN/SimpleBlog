...
public class ShowAllPostController extends HttpServlet {
    ...
    private static final String SUCCESS = "main_page.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PostDTO> list = dao.getAllPostWithStatus(2, skip);
            int total = dao.getTotalPost(2);
            ...
            logger.info("ERROR at GET ALL POST CONTROLLER: " + e.getMessage());
            log("ERROR AT GET ALL POST CONTROLLER: " + e.getMessage());
        } finally {
