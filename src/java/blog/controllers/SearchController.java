...
public class SearchController extends HttpServlet {
    ...
    FileHandler fh;
    private static final String SUCCESS = "search_result.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PostDTO> list = dao.searchPostByTitleWithStatus(search, 2, skip);
            int total = dao.getTotalSearchPost(2, search);
            ...
            logger.info("ERROR at SEARCH CONTROLLER: " + e.getMessage());
