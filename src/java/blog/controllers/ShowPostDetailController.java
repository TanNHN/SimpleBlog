...
private static final Logger logger = Logger.getLogger(SearchPostByAdmin.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = FAIL;
        try {
            int id = Integer.parseInt(request.getParameter("txtPID"));
            PostDAO dao = new PostDAO();
            PostDTO post = dao.showPostDetail(id);
            ...
            logger.info("ERROR at ShowPostController " + e.getMessage());
            log("Error at ShowPostController " + e.getMessage());
        }
