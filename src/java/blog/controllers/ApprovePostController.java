...
public class ApprovePostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean chk = dao.setPostStatus(id, 2);
            if (chk) {
                url = SUCCESS;
            } else {
                request.setAttribute("ERROR", "Error when changed post's status to approval");
            }
        } catch (Exception e) {
            ...
            logger.info("Error at Approve Post Controller: " + e.getMessage());
            log("Error at Approve Post Controller: " + e.getMessage());
        } finally {
