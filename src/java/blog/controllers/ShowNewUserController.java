 ...
 * @author Tan
 */
public class ShowNewUserController extends HttpServlet {

    private static final Logger logger = Logger.getLogger(SearchPostByAdmin.class.getName());

    FileHandler fh;
    private static final String SUCCESS = "new_user_list.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<AccountDTO> list = dao.getAccountWithStatus(1);
            ...
            log("error at Show New User Controller: " + e.getMessage());
        } finally {
