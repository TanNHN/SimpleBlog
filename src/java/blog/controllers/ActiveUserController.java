...
public class ActiveUserController extends HttpServlet {
    ...
    private static final String SUCCESS = "ShowNewUserController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            chk = dao.activeUser(email);
            if (chk) {
                request.setAttribute("STATUS", "User " + email + " has been ativated");
                url = SUCCESS;
            }
        } catch (Exception e) {
            ...
            logger.info("Error at Active user controller: " + e.getMessage());
