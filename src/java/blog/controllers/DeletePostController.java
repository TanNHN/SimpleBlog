...
public class DeletePostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean chk = dao.setPostStatus(id, 3);
            if (chk) {
                url = SUCCESS;
            } else {
                request.setAttribute("ERROR", "Error when changed post's status to deleted");
            }
        } catch (Exception e) {
            ...
            logger.info("Error at DELETE Post Controller: " + e.getMessage());
            log("Error at DELETE Post Controller: " + e.getMessage());
        } finally {
