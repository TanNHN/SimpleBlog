 ...
 * @author Tan
 */
public class SendVerifyCodeController extends HttpServlet {

    private static final Logger logger = Logger.getLogger(SearchPostByAdmin.class.getName());

    FileHandler fh;
    private static final String SUCCESS = "confirm_code.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.info("ERROR AT SEND VERIFY CODE CONTROLLER: " + e.getMessage());
            log("ERROR AT SEND VERIFY CODE CONTROLLER: " + e.getMessage());
        } finally {
